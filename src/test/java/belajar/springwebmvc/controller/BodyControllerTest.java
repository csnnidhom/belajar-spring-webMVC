...
import belajar.springwebmvc.model.HelloRequest;
import belajar.springwebmvc.model.HelloResponse;
...
class BodyControllerTest {
    ...
    @Test
    void testHelloBodyResponse() throws Exception {
        HelloRequest request =new HelloRequest();
        request.setName("Nidhom");
        ...
        mockMvc.perform(
            ...
            Assertions.assertEquals("Hello Nidhom", response.getHello());
        });
    }
}